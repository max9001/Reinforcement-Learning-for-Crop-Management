...
class Odie(object):
    ...
    def choose_action(self, curr_state, possible_actions, eps):
        ...
        # print()
        # print("in outer choose_action")
        # print("value of curr_state:")
        # print(curr_state)
        # print()
        # print("value of possible_actions:")
        # print(possible_actions)
        # print()
        # print("value of q_table:")
        # print(self.q_table)
    ...
    def run(self, agent_host):
        ...
        while not done_update:
            ...
            a0 = self.choose_action(s0, possible_actions, epsilon)
            S.append(s0)
            A.append(a0)
            R.append(0)
            ...
            for t in range(sys.maxsize):
                ...
                if t < T:
                    ...
                    if A[-1] == "present_gift":
                        ...
                        next_a = self.choose_action(s, possible_actions, epsilon)
                        A.append(next_a)
...
if __name__ == '__main__':
    ...
    for iRepeat in range(num_reps):
        ...
        if (iRepeat + 1) % 5 == 0:
            ...
            # if (iRepeat + 1) > 75:
            #     # new functionality - decaying epsilon
